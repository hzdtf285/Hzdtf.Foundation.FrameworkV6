...
namespace StackExchange.Redis
{
    ...
    public sealed partial class ConnectionMultiplexerManager : IConnectionMultiplexerManager, IDisposable
    {
        ...
        /// Redis配置选项解析
        /// </summary>
        private readonly IRedisConfigOptionParse redisConfigOptionParse;

        /// <summary>
        /// 连接转接器字典（Key：连接键，Value：连接转接器）
        /// </summary>
        private static readonly IDictionary<string, IConnectionMultiplexer> dicConnMultis = new ConcurrentDictionary<string, IConnectionMultiplexer>();
        ...
        public ConnectionMultiplexerManager(IRedisConfigOptionParse redisConfigOptionParse)
        {
            this.redisConfigOptionParse = redisConfigOptionParse;
        }
