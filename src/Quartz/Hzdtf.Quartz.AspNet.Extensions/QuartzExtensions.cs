...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class QuartzExtensions
    {
        ...
        public static IServiceCollection AddQuartz(this IServiceCollection services, Action options = null)
        {
            ...
            {
                services.RegisterAssemblyWithInterfaceMapImpls(typeof(IJobHandleException), ServiceLifetime.Singleton, implClassAssemblys: QuartzStaticConfig.JobHandleExceptionAssembly);
            }
