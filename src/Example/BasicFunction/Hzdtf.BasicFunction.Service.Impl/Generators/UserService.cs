...
namespace Hzdtf.BasicFunction.Service.Impl
{
    ...
    /// </summary>
    [Inject]
    public partial class UserService : ServiceBase<int, UserInfo, IUserPersistence>, IUserService
    {
        /// <summary>
        /// 构造方法
        /// </summary>
        ...
        public UserService(ILogable log = null, IUserPersistence persistence = default(IUserPersistence), IIdentity<int> identity = null, ILocalization localize = null)
