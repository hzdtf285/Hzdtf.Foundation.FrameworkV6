...
namespace Hzdtf.BasicFunction.Service.Impl
{
    ...
    /// </summary>
    [Inject]
    public partial class RoleService : ServiceBase<int, RoleInfo, IRolePersistence>, IRoleService
    {
        /// <summary>
        /// 构造方法
        /// </summary>
        ...
        public RoleService(ILogable log = null, IRolePersistence persistence = default(IRolePersistence), IIdentity<int> identity = null, ILocalization localize = null)
