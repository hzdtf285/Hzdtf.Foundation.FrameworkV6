...
namespace Hzdtf.BasicFunction.Service.Impl
{
    ...
    public partial class UserRoleService : ServiceBase<int, UserRoleInfo, IUserRolePersistence>, IUserRoleService
    {
        ...
        public UserRoleService(ILogable log = null, IUserRolePersistence persistence = default(IUserRolePersistence), IIdentity<int> identity = null, ILocalization localize = null)
