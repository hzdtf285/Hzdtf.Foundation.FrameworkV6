...
namespace Hzdtf.BasicFunction.Controller
{
    ...
    public partial class UserController : PagingControllerBase<int, UserInfo, IUserService, UserPageInfo, UserFilterInfo>
    {
        ...
        public UserController(ILogable log = null, IUserService service = null, ILocalization localize = null, ISimpleFactory<HttpContext, CommonUseData> comUseDataFactory = null,
