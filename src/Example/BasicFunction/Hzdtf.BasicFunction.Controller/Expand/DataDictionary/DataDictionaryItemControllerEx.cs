...
namespace Hzdtf.BasicFunction.Controller
{
    ...
    public partial class DataDictionaryItemController
    {
        ...
        public virtual IList<DataDictionaryInfo> DataDictionarys() => DataDictionaryService.Query(comUseDataFactory.Create(HttpContext)).Data;
        ...
        {
            var re = UserService.QueryPageData<PageInfo<int>>("DataDictionary", () =>
            {
