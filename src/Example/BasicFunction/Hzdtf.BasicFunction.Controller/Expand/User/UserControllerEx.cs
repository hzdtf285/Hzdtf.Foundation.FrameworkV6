...
namespace Hzdtf.BasicFunction.Controller
{
    ...
    public partial class UserController
    {
        ...
        public virtual ReturnInfo<bool> ResetUserPassword(ModifyPasswordInfo modifyPassword, string connectionId = null) => service.ResetUserPassword(modifyPassword, comUseDataFactory.Create(HttpContext));
        ...
        {
            var comData = HttpContext.CreateCommonUseData(comUseDataFactory, menuCode: "User", functionCodes: FunCodeDefine.EXPORT_EXCEL_CODE);
        ...
        {
            var re = service.QueryPageData<UserPageInfo>("User", () =>
            {
