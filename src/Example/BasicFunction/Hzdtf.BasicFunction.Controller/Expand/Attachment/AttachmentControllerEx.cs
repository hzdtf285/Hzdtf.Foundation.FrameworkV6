...
namespace Hzdtf.BasicFunction.Controller
{
    ...
    public partial class AttachmentController
    {
        ...
        public virtual ReturnInfo<bool> DeleteByOwner(short ownerType, int ownerId) => service.RemoveByOwner(ownerType, ownerId, comUseDataFactory.Create(HttpContext));
        ...
        protected ReturnInfo<bool> FilterDownLoadPermissionFileAddress(IList<AttachmentInfo> attachments, CommonUseData comData = null)
        {
            ...
            ReturnInfo<bool> returnInfo = UserService.IsCurrUserPermission("Attachment", FunCodeDefine.DOWNLOAD_CODE, comData);
        ...
        {
            var re = UserService.QueryPageData<PageInfo<int>>("Attachment", () =>
            {
