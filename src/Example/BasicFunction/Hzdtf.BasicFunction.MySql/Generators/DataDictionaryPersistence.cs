...
namespace Hzdtf.BasicFunction.MySql
{
    ...
    /// </summary>
    [Inject]
    public partial class DataDictionaryPersistence : MySqlDapperBase<int, DataDictionaryInfo>, IDataDictionaryPersistence
    {
        /// <summary>
        /// 表名
        /// </summary>
        public override string Table => "data_dictionary";
        ...
        public DataDictionaryPersistence(IDefaultConnectionString defaultConnectionString = null, ILogable log = null, IIdentity<int> identity = null, ILocalization localize = null, IDataPermissionFilter dataPermissionFilter = null, IFieldPermissionFilter fieldPermissionFilter = null)
