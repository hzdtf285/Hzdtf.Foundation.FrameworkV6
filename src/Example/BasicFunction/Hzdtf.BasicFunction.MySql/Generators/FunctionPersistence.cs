...
namespace Hzdtf.BasicFunction.MySql
{
    ...
    /// </summary>
    [Inject]
    public partial class FunctionPersistence : MySqlDapperBase<int, FunctionInfo>, IFunctionPersistence
    {
        /// <summary>
        /// 表名
        /// </summary>
        public override string Table => "function";
        ...
        public FunctionPersistence(IDefaultConnectionString defaultConnectionString = null, ILogable log = null, IIdentity<int> identity = null, ILocalization localize = null, IDataPermissionFilter dataPermissionFilter = null, IFieldPermissionFilter fieldPermissionFilter = null)
        ...
        /// <returns>值</returns>
        protected override object GetValueByFieldName(FunctionInfo model, string field)
        {
            switch (field)
            {
﻿                case "id":
