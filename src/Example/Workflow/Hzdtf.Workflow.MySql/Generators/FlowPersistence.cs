...
namespace Hzdtf.Workflow.MySql
{
    ...
    /// </summary>
    [Inject]
    public partial class FlowPersistence : MySqlDapperBase<int, FlowInfo>, IFlowPersistence
    {
        /// <summary>
        /// 表名
        /// </summary>
        public override string Table => "flow";
        ...
        public FlowPersistence(IDefaultConnectionString defaultConnectionString = null, ILogable log = null, IIdentity<int> identity = null, ILocalization localize = null, IDataPermissionFilter dataPermissionFilter = null, IFieldPermissionFilter fieldPermissionFilter = null)
        ...
        /// <returns>值</returns>
        protected override object GetValueByFieldName(FlowInfo model, string field)
        {
            switch (field)
            {
﻿                case "id":
