...
namespace Hzdtf.Workflow.Service.Impl.Engine
{
    ...
    public partial class WorkflowConfigCache : SingleTypeLocalMemoryBase<int, WorkflowDefineInfo>, IWorkflowConfigReader
    {
        ...
        /// 缓存字典
        /// </summary>
        private readonly static IDictionary<int, WorkflowDefineInfo> dicCache = new ConcurrentDictionary<int, WorkflowDefineInfo>();

        /// <summary>
        /// 编码映射ID字典
        /// </summary>
        private readonly static IDictionary<string, int> dicCodeMapId = new ConcurrentDictionary<string, int>();
