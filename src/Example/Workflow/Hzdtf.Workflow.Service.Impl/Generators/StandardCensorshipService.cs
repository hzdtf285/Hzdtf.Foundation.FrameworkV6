...
namespace Hzdtf.Workflow.Service.Impl
{
    ...
    public partial class StandardCensorshipService : ServiceBase<int, StandardCensorshipInfo, IStandardCensorshipPersistence>, IStandardCensorshipService
    {
        ...
        public StandardCensorshipService(ILogable log = null, IStandardCensorshipPersistence persistence = default(IStandardCensorshipPersistence), IIdentity<int> identity = null, ILocalization localize = null)
