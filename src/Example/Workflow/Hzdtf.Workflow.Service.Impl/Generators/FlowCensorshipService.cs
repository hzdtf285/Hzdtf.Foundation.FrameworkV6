...
namespace Hzdtf.Workflow.Service.Impl
{
    ...
    public partial class FlowCensorshipService : ServiceBase<int, FlowCensorshipInfo, IFlowCensorshipPersistence>, IFlowCensorshipService
    {
        ...
        public FlowCensorshipService(ILogable log = null, IFlowCensorshipPersistence persistence = default(IFlowCensorshipPersistence), IIdentity<int> identity = null, ILocalization localize = null)
