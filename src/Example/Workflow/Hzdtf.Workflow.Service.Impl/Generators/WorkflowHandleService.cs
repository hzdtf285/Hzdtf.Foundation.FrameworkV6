...
namespace Hzdtf.Workflow.Service.Impl
{
    ...
    public partial class WorkflowHandleService : ServiceBase<int, WorkflowHandleInfo, IWorkflowHandlePersistence>, IWorkflowHandleService
    {
        ...
        public WorkflowHandleService(ILogable log = null, IWorkflowHandlePersistence persistence = default(IWorkflowHandlePersistence), IIdentity<int> identity = null, ILocalization localize = null)
