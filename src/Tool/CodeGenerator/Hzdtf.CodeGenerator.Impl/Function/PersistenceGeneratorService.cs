...
namespace Hzdtf.CodeGenerator.Impl.Function
{
    ...
    public class PersistenceGeneratorService : FunctionGeneratorBase
    {
        ...
        private string BuilderClassCode(TableInfo table, CodeParamInfo codeParam, out string fileName)
        {
            ...
            var overideIdFieldName = new StringBuilder();
            ...
            if (!table.Columns.IsNullOrCount0())
            {
                for (int i = 0; i < table.Columns.Count; i++)
                {
                    ...
                    {
                        overideIdFieldName.AppendFormat("/// <summary>\r\n        /// Id字段名\r\n        /// </summary>\r\n        protected override string IdFieldName {{ get => \"{0}\"; }}", c.Name);
                    }
            ...
            .Replace("|OverideIdFieldName|", overideIdFieldName.ToString());
        }
