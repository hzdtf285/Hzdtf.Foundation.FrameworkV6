...
namespace Hzdtf.CodeGenerator.Impl.Function
{
    ...
    public class ModelGeneratorService : FunctionGeneratorBase
    {
        ...
        {
            "Id", "MerchantId", "CreateTime", "ModifyTime", "CreaterId", "Creater", "ModifierId", "Modifier"
        };
        ...
        {
            "LoginId", "MerchantId", "Password", "LoginTime", "LoginIp", "Logins", "LogoutTime", "Code", "Name", "Enabled", "SystemInlay"
        };
