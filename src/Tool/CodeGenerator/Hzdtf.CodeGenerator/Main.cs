...
namespace Hzdtf.CodeGenerator
{
    ...
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            cbxDataSourceType.SelectedItem = dataConfig.DataSource.Type;
        ...
        {
            var reader = App.GetServiceFromInstance<IReader<IDictionary<string, string>>>();
        ...
        private void btnTestConn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var factory = App.GetServiceFromInstance<ISimpleFactory<string, IDbConnection>>();
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var dbInfoService = App.GetServiceFromInstance<IDbInfoService>();
        ...
        private void btnBuilder_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                param.IsMerchant = cbxTenant.Checked;
