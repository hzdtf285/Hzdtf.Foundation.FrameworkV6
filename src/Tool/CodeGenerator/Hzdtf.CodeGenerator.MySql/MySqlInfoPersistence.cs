...
namespace Hzdtf.CodeGenerator.MySql
{
    /// <summary>
    /// MySql信息持久化
    /// @ 黄振东
    ...
    public class MySqlInfoPersistence : IDbInfoPersistence
    {
        ...
        public IList<KeyValueInfo<string, string>> SelectPrimaryKeyColumnsByTables(string connectionString, params string[] tables) => null;
    }
}
