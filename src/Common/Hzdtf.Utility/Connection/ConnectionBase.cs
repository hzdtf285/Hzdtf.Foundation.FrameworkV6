...
namespace Hzdtf.Utility.Connection
{
        ...
        where ConnectionInfoT : ConnectionInfo
    {
        ...
        /// 连接字符串解析器
        /// </summary>
        protected IConnectionStringParse<ConnectionInfoT> connectionStringParse;
        ...
        /// 构造方法
        /// </summary>
        /// <param name="connectionStringParse">连接字符串解析器</param>
        public ConnectionBase(IConnectionStringParse<ConnectionInfoT> connectionStringParse = null)
        {
    ...
    public abstract class ConnectionBase : ConnectionBase<ConnectionInfo>, IConnection
    {
        ...
        /// </summary>
        /// <param name="connectionStringParse">连接字符串解析器</param>
        public ConnectionBase(IConnectionStringParse<ConnectionInfo> connectionStringParse = null)
            : base(connectionStringParse)
        {
        }
    }
}
