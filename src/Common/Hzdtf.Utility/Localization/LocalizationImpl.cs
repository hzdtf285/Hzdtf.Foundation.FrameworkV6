...
namespace Hzdtf.Utility.Localization
{
    ...
    public class LocalizationImpl : ILocalization
    {
        ...
        /// 文化库
        /// </summary>
        protected readonly ICultureLibrary cultureLibrary;

        /// <summary>
        /// 构造方法
        /// </summary>
        /// <param name="cultureLibrary">文化库</param>
        public LocalizationImpl(ICultureLibrary cultureLibrary = null)
        {
            this.cultureLibrary = cultureLibrary;
        }
