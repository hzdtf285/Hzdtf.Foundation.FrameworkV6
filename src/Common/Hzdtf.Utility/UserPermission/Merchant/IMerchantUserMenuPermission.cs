...
namespace Hzdtf.Utility.UserPermission.Merchant
{
    ...
    public interface IMerchantUserMenuPermission<IdT>
    {
        /// <summary>
        /// 用户是否拥有权限
        /// </summary>
        ...
        ReturnInfo<bool> UserHavePermission(IdT merchantId, IdT userId, string menuCode, string[] funCodes, CommonUseData comData = null);
