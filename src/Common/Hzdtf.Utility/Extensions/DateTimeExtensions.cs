...
namespace System
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// 1970的日期
        /// </summary>
        public static readonly DateTime DATE_1970 = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Local);
        ...
        public static DateTime ToLessThanDate(this DateTime dateTime)
        {
            ...
            return new DateTime(temp.Year, temp.Month, temp.Day, 0, 0, 0, DateTimeKind.Local);
        }
        ...
        {
            return new DateTime(dateTime.Year, dateTime.Month, dateTime.PlaceMonthOfDay(), 23, 59, 59, 999, DateTimeKind.Local);
        }
        ...
        public static DateTime QuarterLastDay(this DateTime dateTime)
        {
            ...
            {
                case 0:
                    return new DateTime(dateTime.Year, 3, 31, 23, 59, 59, 999, DateTimeKind.Local);

                case 1:
                    return new DateTime(dateTime.Year, 6, 30, 23, 59, 59, 999, DateTimeKind.Local);

                case 2:
                    return new DateTime(dateTime.Year, 9, 30, 23, 59, 59, 999, DateTimeKind.Local);
        ...
        public static DateTime QuarterFirstDay(this DateTime dateTime)
        {
            switch (dateTime.GetQuarter())
            {
                ...
                case 1:
                    return new DateTime(dateTime.Year, 4, 1, 0, 0, 0, DateTimeKind.Local);

                case 2:
                    return new DateTime(dateTime.Year, 7, 1, 0, 0, 0, DateTimeKind.Local);

                default:
                    return new DateTime(dateTime.Year, 10, 1, 0, 0, 0, DateTimeKind.Local);
            }
        }
        ...
        public static DateTime ToMonday(this DateTime dateTime)
        {
            ...
            return new DateTime(newDateTime.Year, newDateTime.Month, newDateTime.Day, 0, 0, 0, DateTimeKind.Local);
        }
...
#pragma warning restore CS0618 // 类型或成员已过时
        ...
        /// <summary>
        /// 获取CST日期时间（统一的日期时间，默认为上海时区）
        /// </summary>
        /// <param name="instant">片刻对象</param>
        /// <returns>CST日期时间</returns>
        public static DateTime GetCstDateTime(this Instant instant)
        {
            var shanghaiZone = DateTimeZoneProviders.Tzdb["Asia/Shanghai"];
            var zone = instant.InZone(shanghaiZone);
            return zone.ToDateTimeUnspecified();
        }
        ...
        /// <summary>
        /// 将原始日期时间转换为CST日期时间（统一的日期时间，默认为上海时区）
        /// </summary>
        /// <param name="dateTime">日期时间</param>
        /// <returns>CST日期时间</returns>
        ...
        /// <summary>
        /// 将原始日期时间字符串转换为CST日期时间（统一的日期时间，默认为上海时区）
        /// </summary>
        /// <param name="dateTimeStr">日期时间字符串</param>
        /// <returns>CST日期时间</returns>
        public static DateTime ToCstDateTime(this string dateTimeStr)
        {
            ...
            // 取最后一个字符
            var lastChar = dateTimeStr[dateTimeStr.Length - 1];
            // 如果带有时区格式
            if (lastChar == 'Z' || lastChar == 'z')
            {
                var dataTime = DateTime.Parse(dateTimeStr, styles: DateTimeStyles.AdjustToUniversal);
                return Instant.FromDateTimeUtc(dataTime).GetCstDateTime();
            }

            return DateTime.Parse(dateTimeStr, styles: DateTimeStyles.AssumeLocal);
        }
    }
}
