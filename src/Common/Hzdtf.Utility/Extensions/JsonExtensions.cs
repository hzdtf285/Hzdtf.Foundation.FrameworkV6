...
namespace System
{
    ...
    public static class JsonExtensions
    {
        ...
        {
            return obj.ToJsonString(isIgnoreNull: true, isUseCamel: true, format: Newtonsoft.Json.Formatting.None, nullDefaultValue: null);
        }
        ...
        /// <param name="nullDefaultValue">如果为null的默认值</param>
        /// <returns>JSON字符串</returns>
        public static string ToJsonString(this object obj, bool isIgnoreNull = true, bool isUseCamel = true, Formatting format = Formatting.None, string nullDefaultValue = null)
        {
            if (obj == null)
            {
