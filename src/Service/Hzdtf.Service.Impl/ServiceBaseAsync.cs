...
namespace Hzdtf.Service.Impl
{
        ...
        where PersistenceT : IPersistence<IdT, ModelT>
    {
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<ModelT>> FindAsync(IdT id, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<ModelT>>(() =>
            {
                return Find(id, propertyName, isPropertyGetNot, comData, connectionId);
            });
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<IList<ModelT>>> FindAsync(IdT[] ids, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<IList<ModelT>>>(() =>
            {
                return Find(ids, propertyName, isPropertyGetNot, comData, connectionId);
            });
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<IList<ModelT>>> QueryAsync(string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<IList<ModelT>>>(() =>
            {
                return Query(propertyNames, isPropertyGetNot, comData, connectionId);
            });
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<PagingInfo<ModelT>>> QueryPageAsync(int pageIndex, int pageSize, string[] propertyNames, bool isPropertyGetNot = false, FilterInfo filter = null, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<PagingInfo<ModelT>>>(() =>
            {
                return QueryPage(pageIndex, pageSize, propertyNames, isPropertyGetNot, filter, comData, connectionId);
            });
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<bool>> AddAsync(ModelT model, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<bool>>(() =>
            {
                return Add(model, propertyNames, isPropertyGetNot, comData, connectionId);
            });
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<bool>> AddAsync(IList<ModelT> models, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<bool>>(() =>
            {
                return Add(models, propertyNames, isPropertyGetNot, comData, connectionId);
            });
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<bool>> SetAsync(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<bool>>(() =>
            {
                return Set(model, propertyNames, isPropertyGetNot, comData, connectionId);
            });
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        public virtual async Task<ReturnInfo<bool>> ModifyByIdAsync(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return await Task.Run<ReturnInfo<bool>>(() =>
            {
                return ModifyById(model, propertyNames, isPropertyGetNot, comData, connectionId);
            });
        }
