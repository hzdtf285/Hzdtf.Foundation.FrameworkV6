...
namespace Hzdtf.Service.Impl
{
        ...
        where PersistenceT : IPersistence<IdT, ModelT>
    {
        ...
        /// 持久化
        /// </summary>
        protected readonly PersistenceT persistence;
        ...
        public ServiceBase(ILogable log = null, PersistenceT persistence = default(PersistenceT), IIdentity<IdT> identity = null, ILocalization localize = null)
            : base(log)
        {
        ...
        {
            return Find(id, null, false, comData, connectionId);
        }
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<ModelT> Find([Id] IdT id, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            bool isClose = false;
            ...
            try
            {
                ...
                {
                    return persistence.Select(id, propertyNames: propertyName, isPropertyGetNot: isPropertyGetNot, comData: comData, connectionId: connectionId);
                }, returnInfo);
        ...
        {
            return Find(ids, null, false, comData, connectionId);
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<IList<ModelT>> Find(IdT[] ids, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            bool isClose = false;
            if (string.IsNullOrWhiteSpace(connectionId))
            {
            ...
            try
            {
                ...
                {
                    return persistence.Select(ids, propertyName, isPropertyGetNot: isPropertyGetNot, comData: comData, connectionId: connectionId);
                }, returnInfo);
        ...
        {
            return Query(null, false, comData, connectionId);
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<IList<ModelT>> Query(string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            bool isClose = false;
            if (string.IsNullOrWhiteSpace(connectionId))
            {
            ...
            try
            {
                ...
                returnInfo = ExecReturnFunc<IList<ModelT>>((reInfo) =>
                {
                    return persistence.Select(propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, comData: comData, connectionId);
                }, returnInfo);
        ...
        {
            return QueryPage(pageIndex, pageSize, null, false, filter, comData, connectionId);
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<PagingInfo<ModelT>> QueryPage([PageIndex] int pageIndex, [PageSize] int pageSize, string[] propertyNames, bool isPropertyGetNot = false, FilterInfo filter = null, CommonUseData comData = null, string connectionId = null)
        {
            bool isClose = false;
            if (string.IsNullOrWhiteSpace(connectionId))
            {
            ...
            try
            {
                ...
                {
                    return persistence.SelectPage(pageIndex, pageSize, propertyNames, isPropertyGetNot: isPropertyGetNot, filter, comData: comData, connectionId: connectionId);
                }, returnInfo);
        ...
        {
            return Add(model, null, false, comData, connectionId);
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<bool> Add([DisplayName2("模型"), Required, Model] ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            ...
            try
            {
                ...
                returnInfo = ExecReturnFunc<bool>((reInfo) =>
                {
                    return persistence.Insert(model, propertyNames, isPropertyGetNot: isPropertyGetNot, comData: comData, connectionId: connectionId) > 0;
                }, returnInfo);
        ...
        {
            return Add(models, null, false, comData, connectionId);
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<bool> Add([DisplayName2("模型列表"), MultiModel] IList<ModelT> models, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            ...
            try
            {
                ...
                returnInfo = ExecReturnFunc<bool>((reInfo) =>
                {
                    return persistence.Insert(models, isPropertyGetNot: isPropertyGetNot, comData: comData, connectionId: connectionId) > 0;
                }, returnInfo);
        ...
        {
            return Set(model, null, false, comData, connectionId);
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<bool> Set([DisplayName2("模型"), Required, Model] ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            bool isClose = false;
            if (string.IsNullOrWhiteSpace(connectionId))
            {
            ...
            try
            {
                ...
                returnInfo = ExecReturnFuncAndConnectionId<bool>((reInfo, connId) =>
                {
                    ...
                    ReturnInfo<bool> re = exists ? ModifyById(model, propertyNames, isPropertyGetNot: isPropertyGetNot, comData, connId) : Add(model, null, isPropertyGetNot: isPropertyGetNot, comData, connId);
                    reInfo.FromBasic(re);
        ...
        {
            return ModifyById(model, null, false, comData, connectionId);
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        public virtual ReturnInfo<bool> ModifyById([DisplayName2("模型"), Required, Model] ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null)
        {
            return ExecReturnFuncAndConnectionId<bool>((reInfo, connId) =>
            {
                ...
                var result = persistence.UpdateById(model, propertyNames, isPropertyGetNot: isPropertyGetNot, comData: comData, connectionId: connectionId) > 0;
