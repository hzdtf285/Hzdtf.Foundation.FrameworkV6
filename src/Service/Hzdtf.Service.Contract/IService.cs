...
namespace Hzdtf.Service.Contract
{
        ...
        where ModelT : SimpleInfo<IdT>
    {
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>返回信息</returns>
        ReturnInfo<ModelT> Find(IdT id, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<IList<ModelT>> Find(IdT[] ids, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<IList<ModelT>> Query(string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<PagingInfo<ModelT>> QueryPage(int pageIndex, int pageSize, string[] propertyNames, bool isPropertyGetNot = false, FilterInfo filter = null, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<bool> Add(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<bool> Add(IList<ModelT> models, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<bool> Set(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息</returns>
        ReturnInfo<bool> ModifyById(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
