...
namespace Hzdtf.Service.Contract
{
        ...
        where ModelT : SimpleInfo<IdT>
    {
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<ModelT>> FindAsync(IdT id, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<IList<ModelT>>> FindAsync(IdT[] ids, string[] propertyName = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<IList<ModelT>>> QueryAsync(string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<PagingInfo<ModelT>>> QueryPageAsync(int pageIndex, int pageSize, string[] propertyNames, bool isPropertyGetNot = false, FilterInfo filter = null, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<bool>> AddAsync(ModelT model, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<bool>> AddAsync(IList<ModelT> models, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<bool>> SetAsync(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>返回信息任务</returns>
        Task<ReturnInfo<bool>> ModifyByIdAsync(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
