...
namespace Hzdtf.MySql
{
    ...
    /// </summary>
    [Inject]
    public sealed class MySqlDefault : PersistenceConnectionBase, IPersistenceConnectionDefault
    {
        /// <summary>
        /// 构造方法
        /// </summary>
        ...
        public MySqlDefault(IDefaultConnectionString defaultConnectionString = null, ILogable log = null)
