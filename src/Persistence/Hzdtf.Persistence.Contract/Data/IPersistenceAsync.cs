...
namespace Hzdtf.Persistence.Contract.Data
{
        ...
        where ModelT : SimpleInfo<IdT>
    {
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型任务</returns>
        Task<ModelT> SelectAsync(IdT id, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型任务</returns>
        Task<IList<ModelT>> SelectAsync(IdT[] ids, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型列表任务</returns>
        Task<IList<ModelT>> SelectAsync(string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>分页信息任务</returns>
        Task<PagingInfo<ModelT>> SelectPageAsync(int pageIndex, int pageSize, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, FilterInfo filter = null, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型列表任务</returns>
        Task<IList<ModelT>> SelectAsync(SqlPropInfo param, ref string connectionId, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型数任务</returns>
        Task<int> CountAsync(SqlPropInfo param, ref string connectionId, CommonUseData comData = null);
        ...
        Task<PagingInfo<ModelT>> SelectPageAsync(int pageIndex, int pageSize, SqlPropInfo param, ref string connectionId, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数任务</returns>
        Task<int> InsertAsync(ModelT model, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数任务</returns>
        Task<int> InsertAsync(IList<ModelT> models, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数任务</returns>
        Task<int> UpdateByIdAsync(ModelT model, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数任务</returns>
        Task<int> UpdateAsync(SqlPropInfo param, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数任务</returns>
        Task<int> DeleteAsync(SqlPropInfo param, CommonUseData comData = null, string connectionId = null);
