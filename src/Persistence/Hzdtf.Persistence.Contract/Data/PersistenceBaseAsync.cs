...
namespace Hzdtf.Persistence.Contract.Data
{
        ...
        where ModelT : SimpleInfo<IdT>
    {
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型任务</returns>
        public virtual Task<ModelT> SelectAsync(IdT id, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            Task<ModelT> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<ModelT>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Select(id, dbConn, propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, dbTransaction: dbTrans, comData: comData);
                }, AccessMode.SLAVE);
            }, accessMode: AccessMode.SLAVE);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型任务</returns>
        public virtual Task<IList<ModelT>> SelectAsync(IdT[] ids, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            Task<IList<ModelT>> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<IList<ModelT>>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Select(ids, dbConn, propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, dbTransaction: dbTrans, comData: comData);
                }, AccessMode.SLAVE);
            }, accessMode: AccessMode.SLAVE);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型列表任务</returns>
        public virtual Task<IList<ModelT>> SelectAsync(string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            Task<IList<ModelT>> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<IList<ModelT>>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Select(dbConn, propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, dbTransaction: dbTrans, comData: comData);
                }, AccessMode.SLAVE);
            }, accessMode: AccessMode.SLAVE);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>分页信息任务</returns>
        public virtual Task<PagingInfo<ModelT>> SelectPageAsync(int pageIndex, int pageSize, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, FilterInfo filter = null, CommonUseData comData = null)
        {
            Task<PagingInfo<ModelT>> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<PagingInfo<ModelT>>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return SelectPage(pageIndex, pageSize, dbConn, filter, propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, dbTransaction: dbTrans, comData: comData);
                }, AccessMode.SLAVE);
            }, accessMode: AccessMode.SLAVE);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型列表任务</returns>
        public virtual Task<IList<ModelT>> SelectAsync(SqlPropInfo param, ref string connectionId, CommonUseData comData = null)
        {
            Task<IList<ModelT>> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<IList<ModelT>>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Select(param, comData, connectionId: connId);
                }, AccessMode.SLAVE);
            }, accessMode: AccessMode.SLAVE);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>模型数任务</returns>
        public virtual Task<int> CountAsync(SqlPropInfo param, ref string connectionId, CommonUseData comData = null)
        {
            Task<int> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<int>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Count(param, comData, connectionId: connId);
                }, AccessMode.SLAVE);
            }, accessMode: AccessMode.SLAVE);
        ...
        public virtual Task<PagingInfo<ModelT>> SelectPageAsync(int pageIndex, int pageSize, SqlPropInfo param, ref string connectionId, CommonUseData comData = null)
        {
            Task<PagingInfo<ModelT>> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<PagingInfo<ModelT>>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return SelectPage(pageIndex, pageSize, param, comData, connectionId: connId);
                }, AccessMode.SLAVE);
            }, accessMode: AccessMode.SLAVE);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数任务</returns>
        public virtual Task<int> InsertAsync(ModelT model, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            Task<int> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<int>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Insert(model, dbConn, propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, dbTransaction: dbTrans, comData: comData);
                });
            });
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数任务</returns>
        public virtual Task<int> InsertAsync(IList<ModelT> models, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            Task<int> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<int>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Insert(models, dbConn, isPropertyGetNot: isPropertyGetNot, dbTransaction: dbTrans, comData: comData);
                });
            });
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数任务</returns>
        public virtual Task<int> UpdateByIdAsync(ModelT model, string[] propertyNames, ref string connectionId, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            Task<int> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<int>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return UpdateById(model, dbConn, propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, dbTransaction: dbTrans, comData: comData);
                });
            });
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数任务</returns>
        public virtual Task<int> UpdateAsync(SqlPropInfo param, CommonUseData comData = null, string connectionId = null)
        {
            Task<int> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<int>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Update(param: param, dbConn, dbTransaction: dbTrans, comData: comData);
                });
            });
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数任务</returns>
        public virtual Task<int> DeleteAsync(SqlPropInfo param, CommonUseData comData = null, string connectionId = null)
        {
            Task<int> task = null;
            DbConnectionManager.BrainpowerExecuteAsync(ref connectionId, this, (connId, isClose, dbConn) =>
            {
                task = ExecAsync<int>(connId, isClose, dbConn, (dbTrans) =>
                {
                    return Delete(param: param, dbConn, dbTransaction: dbTrans, comData: comData);
                });
            });
