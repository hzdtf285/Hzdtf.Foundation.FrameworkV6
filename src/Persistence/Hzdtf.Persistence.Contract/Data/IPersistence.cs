...
namespace Hzdtf.Persistence.Contract.Data
{
        ...
        where ModelT : SimpleInfo<IdT>
    {
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>模型</returns>
        ModelT Select(IdT id, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>模型</returns>
        IList<ModelT> Select(IdT[] ids, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>模型列表</returns>
        IList<ModelT> Select(string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>分页信息</returns>
        PagingInfo<ModelT> SelectPage(int pageIndex, int pageSize, string[] propertyNames, bool isPropertyGetNot = false, FilterInfo filter = null, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>模型列表</returns>
        IList<ModelT> Select(SqlPropInfo param, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>模型数</returns>
        int Count(SqlPropInfo param, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>分页信息</returns>
        PagingInfo<ModelT> SelectPage(int pageIndex, int pageSize, SqlPropInfo param, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数</returns>
        int Insert(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数</returns>
        int Insert(IList<ModelT> models, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数</returns>
        int UpdateById(ModelT model, string[] propertyNames, bool isPropertyGetNot = false, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数</returns>
        int Update(SqlPropInfo param, CommonUseData comData = null, string connectionId = null);
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>影响行数</returns>
        int Delete(SqlPropInfo param, CommonUseData comData = null, string connectionId = null);
