...
namespace Hzdtf.Persistence.Contract.Basic
{
    ...
    /// @ 黄振东
    /// </summary>
    public interface IEnvironmentTypeConnectionFactory : ISimpleFactory<EnvironmentType, string[]>
    {
    }
    ...
    /// </summary>
    [Inject]
    public class DefaultConnectionStringFactory : IEnvironmentTypeConnectionFactory
    {
        /// <summary>
        /// 创建
        /// </summary>
