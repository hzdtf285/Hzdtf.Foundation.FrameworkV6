...
namespace Hzdtf.Persistence.Dapper
{
        ...
        where ModelT : SimpleInfo<IdT>
    {
        ...
        /// Id字段名，默认为“Id”
        /// </summary>
        protected virtual string IdFieldName { get => "Id"; }
        ...
        public DapperPersistenceBase(IDefaultConnectionString defaultConnectionString = null, ILogable log = null, IIdentity<IdT> identity = null, ILocalization localize = null, IDataPermissionFilter dataPermissionFilter = null, IFieldPermissionFilter fieldPermissionFilter = null)
        ...
        /// <returns>模型</returns>
        protected override ModelT Select(IdT id, IDbConnection dbConnection, IDbTransaction dbTransaction = null, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            ...
            var sql = SelectSql(id, dataPermissionSql, fieldPermissionSql, propertyNames, isPropertyGetNot: isPropertyGetNot, comData: comData);
            if (dataParameter == null)
            {
                dataParameter = new DynamicParameters();
            }
            dataParameter.Add($"@{GetPropByField(IdFieldName)}", id);
        ...
        protected override IList<ModelT> Select(IdT[] ids, IDbConnection dbConnection, IDbTransaction dbTransaction = null, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            DynamicParameters dataParameter = null;
            var dataPermissionSql = ExecDataPermissionFilter("Select", dbConnection, dbTransaction, ref dataParameter, comData: comData);
            ...
            var sql = SelectSql(ids, dataPermissionSql, fieldPermissionSql, out parameters, propertyNames, isPropertyGetNot, comData: comData);
        ...
        /// <param name="isPropertyGetNot">属性是否取反，如果取反，则propertyNames则为排除的属性名称集合</param>
        /// <param name="comData">通用数据</param>
        protected override IList<ModelT> Select(IDbConnection dbConnection, IDbTransaction dbTransaction = null, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            DynamicParameters dataParameter = null;
            var dataPermissionSql = ExecDataPermissionFilter("Select", dbConnection, dbTransaction, ref dataParameter, comData: comData);
            ...
            var sql = SelectSql(propertyNames: propertyNames, isPropertyGetNot: isPropertyGetNot, dataPermissionSql: dataPermissionSql, fieldPermissionSql: fieldPermissionSql, comData: comData);
        ...
        protected override PagingInfo<ModelT> SelectPage(int pageIndex, int pageSize, IDbConnection dbConnection, FilterInfo filter = null, IDbTransaction dbTransaction = null, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            ...
            }, (recommendPageIndex) =>
            {
                ...
                DynamicParameters parameters;
                var pageSql = SelectPageSql(recommendPageIndex, pageSize, dataPermissionSql, fieldPermissionSql, out parameters, filter, propertyNames, isPropertyGetNot: isPropertyGetNot, comData: comData);
        ...
        /// <returns>模型列表</returns>
        protected override IList<ModelT> Select(SqlPropInfo param, IDbConnection dbConnection, IDbTransaction dbTransaction = null, CommonUseData comData = null, string connectionId = null)
        {
            var sql = SelectSql(param, comData);
            return ExecRecordSqlLog<IList<ModelT>>(sql, () =>
            {
                return dbConnection.Query<ModelT>(sql, param.Params, dbTransaction).AsList();
            }, comData: comData, "Select");
        }
        ...
        /// <param name="connectionId">连接ID</param>
        /// <returns>模型数</returns>
        protected override int Count(SqlPropInfo param, IDbConnection dbConnection, IDbTransaction dbTransaction = null, CommonUseData comData = null, string connectionId = null)
        {
            var sql = CountSql(param, comData);
            return ExecRecordSqlLog<int>(sql, () =>
            {
                return dbConnection.ExecuteScalar<int>(sql, param.Params, dbTransaction);
            }, comData: comData, "Count");
        }
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>分页信息</returns>
        protected override PagingInfo<ModelT> SelectPage(int pageIndex, int pageSize, IDbConnection dbConnection, SqlPropInfo param, IDbTransaction dbTransaction = null, CommonUseData comData = null)
        {
            return PagingUtil.ExecPage<ModelT>(pageIndex, pageSize, () =>
            {
                var countSql = CountSql(param, comData: comData);
                return ExecRecordSqlLog<int>(countSql, () =>
                {
                    return dbConnection.ExecuteScalar<int>(countSql, param.Params, dbTransaction);
                }, comData: comData, "SelectPage");
            }, (recommendPageIndex) =>
            {
                var pageSql = SelectPageSql(recommendPageIndex, pageSize, param, comData);
                return ExecRecordSqlLog<IList<ModelT>>(pageSql, () =>
                {
                    return dbConnection.Query<ModelT>(pageSql, param.Params, dbTransaction).AsList();
                }, comData: comData, "SelectPage");
            });
        }
        ...
        protected override int Insert(ModelT model, IDbConnection dbConnection, string[] propertyNames = null, bool isPropertyGetNot = false, IDbTransaction dbTransaction = null, CommonUseData comData = null)
        {
            var isAuto = PrimaryKeyIncr(model.Id);
            var sql = InsertSql(model, propertyNames, isPropertyGetNot, isAuto, comData: comData);
        ...
        {
            DynamicParameters parameters;
            var sql = InsertSql(models, out parameters, propertyNames, isPropertyGetNot: isPropertyGetNot, comData: comData);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数</returns>
        protected override int UpdateById(ModelT model, IDbConnection dbConnection, IDbTransaction dbTransaction = null, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null)
        {
            var sql = UpdateByIdSql(model, propertyNames, isPropertyGetNot, comData: comData);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数</returns>
        protected override int Update(SqlPropInfo param, IDbConnection dbConnection, IDbTransaction dbTransaction = null, CommonUseData comData = null)
        {
            var sql = UpdateSql(param, comData: comData);

            return ExecRecordSqlLog<int>(sql, () =>
            {
                var rowCount = dbConnection.Execute(sql, param.Params, dbTransaction);
                return rowCount == 0 && IsSupportIdempotent ? 1 : rowCount;
            }, comData: comData, "Update");
        }
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>影响行数</returns>
        protected override int Delete(SqlPropInfo param, IDbConnection dbConnection, IDbTransaction dbTransaction = null, CommonUseData comData = null)
        {
            var sql = DeleteSql(param, comData: comData);
        ...
        protected abstract string SelectSql(IdT id, string dataPermissionSql, string fieldPermissionSql, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>SQL语句</returns>
        protected abstract string SelectSql(IdT[] ids, string dataPermissionSql, string fieldPermissionSql, out DynamicParameters parameters, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>SQL语句</returns>
        protected abstract string SelectSql(string pfx = null, string appendFieldSqls = null, string[] propertyNames = null, bool isPropertyGetNot = false, string dataPermissionSql = null, string fieldPermissionSql = null, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>SQL语句</returns>
        protected abstract string SelectPageSql(int pageIndex, int pageSize, string dataPermissionSql, string fieldPermissionSql, out DynamicParameters parameters, FilterInfo filter = null, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        protected abstract string SelectSql(SqlPropInfo param, CommonUseData comData = null);
        ...
        protected abstract string CountSql(SqlPropInfo param, CommonUseData comData = null);
        ...
        protected abstract string SelectPageSql(int pageIndex, int pageSize, SqlPropInfo param, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>SQL语句</returns>
        protected abstract string InsertSql(ModelT model, string[] propertyNames = null, bool isPropertyGetNot = false, bool isGetInsertId = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>SQL语句</returns>
        protected abstract string InsertSql(IList<ModelT> models, out DynamicParameters parameters, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        /// <param name="comData">通用数据</param>
        /// <returns>SQL语句</returns>
        protected abstract string UpdateByIdSql(ModelT model, string[] propertyNames = null, bool isPropertyGetNot = false, CommonUseData comData = null);
        ...
        protected abstract string UpdateSql(SqlPropInfo param, CommonUseData comData = null);
        ...
        protected abstract string DeleteSql(SqlPropInfo param, CommonUseData comData = null);
